...
public:
  ...
  virtual const char *what() const throw() { return what_s.c_str(); }
...
class FuseCommandParser {
  ...
  boost::xpressive::sregex constprop, constcount, callcontext, deadpath,
      pointsto, analysis;

  boost::xpressive::sregex composer;
  boost::xpressive::sregex analysisList, atailseq, scommand, ctailseq, tailseq,
      headseq, command;
