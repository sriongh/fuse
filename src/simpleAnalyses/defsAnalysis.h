...
// void mapPath(mapFunctor& f, CFGNode start, const std::set<CFGNode>& endNodes,
// bool includeEndNode) {
...
//   public:
//   DefsAnalysis(Composer* composer, checkDataflowInfoPass* cdip,
//   VariableIdMapping& vIDMap, VariableIdMapping::VariableIdSet& defs) :
...
//
//   public:
//   FuseRDAstAttribute(Composer* composer, checkDataflowInfoPass* cdip,
//   VariableIdMapping& vIDMap, Label label, Labeler& labeler);
//   ~FuseRDAstAttribute();
//
//   public:
//
...
//   VariableIdMapping& vIDMap, Labeler& labeler);
...
//
//   public:
//   FuseRDAstAttribute(Fuse& f, Label label, Labeler& labeler,
//   VariableIdMapping& varIDMap); ~FuseRDAstAttribute();
//
//   static set<VariableId> memlocs2varids(const set<SSAMemLocObjectPtr>&
//   memlocs, VariableIdMapping& varIDMap);
//
//   public:
//
//   bool isBottomElement() { assert(0); }
...
//     for(set<SSAMemLocObjectPtr>::iterator ml=memlocs.begin();
//     ml!=memlocs.end(); ++ml) {
//       f.getDefs(*ml);
//     }
//   }
