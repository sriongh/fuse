...
#if 1 /* Commented out for now because the genericDataflow API changed from    \
         under us. [RPM 2012-09-24] */
...
bool TaintLattice::operator==(
    /*const*/ Lattice *other_) /*const*/ /*override*/ {
  TaintLattice *other = dynamic_cast<TaintLattice *>(other_);
  assert(other != NULL);
