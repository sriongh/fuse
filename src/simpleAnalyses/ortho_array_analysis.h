...
public:
  ...
  MType getMType() const { return mtype; }
...
class ArrayAnalysis : public UndirDataflow {
  ...
  // Variant of Expr2Val where Part field is ignored since it makes no
  // difference for the syntactic analysis.
  MemLocObjectPtr Expr2MemLoc(SgNode *n, PartEdgePtr pedge);
  bool implementsExpr2MemLoc() { return true; }

  // pretty print for the object
  std::string str(std::string indent = "") const { return "ArrayAnalysis"; }
};
}; // namespace fuse
#endif
