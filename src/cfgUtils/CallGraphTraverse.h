...
public:
  ...
  // same each time get_declaration is called and to be the canonical
  // declaration
  ...
  // Returns the parameters of this function if it is known and NULL if it is
  // not
  ...
  static void addVirtualOverrides(SgFunctionDeclaration *decl,
